...
영어·중국어 읽기 속도를 올리고 싶은데, 시중 속독법이 미덥지 않으셨나요? **리드패스트**는 읽기과학·학습과학에서 **전이가 검증된 기법만** 구현한 무료 훈련 앱입니다. 결제도, 가입도 없습니다.

핵심 전제는 하나입니다 — **읽기 속도의 병목은 “눈”이 아니라 “뇌의 어휘 처리”다.** 그래서 시야폭 확장·RSVP 만능·1만 WPM·포토리딩 같은 주장은 「원리」 탭에서 명시적으로 반박하고, 대신 진짜 레버를 훈련합니다.

- **어휘 자동화 + 커버리지** — 빈도순 간격반복으로 단어 인지를 빠르고 일정하게
- **ERR 정독** — 점수 = 속도 × 이해율(이해 60% 미만은 0점). 훑기로는 못 이깁니다
- **정복(Conquer) 모드** — 어려운 글을 1차 독해로 장악 → 반복 속독 → 새 글 전이
- **논문 3-패스 · 자기설명·인출 · 중국어 분할/글자인지**
