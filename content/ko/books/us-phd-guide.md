...
subtitle: "토플시험 준비부터 유학비자 받을 때까지, 모든 노하우를 공개합니다."
date: 2026-06-20
categories: ["유학"]
...
- 합격한 SOP(연구계획서)와 CV 템플릿
- 줌 인터뷰, 추천서, 지원, 대기자(웨이트리스트) 전략
- 합격 이후 I-20 수령부터 F-1 비자 서류와 영사 인터뷰까지
- AI 에이전트를 비서처럼 쓰는 워크플로 템플릿 8개, QR로 받는 실제 샘플 문서 11종

## 누구를 위한 책인가

유학을 마음먹었거나 준비 중인데, 뭐부터 해야 할 지 막막한 사람. 비싼 컨설팅 없이 스스로 유학을 준비해보려는 사람. 이공계 대학원과 미국 박사과정을 염두에 둔 사람.
