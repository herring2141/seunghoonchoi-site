...
reviewStatus: "done"
---
素材の構造、プロセス条件、実際の性能のあいだの関係を、もっと予測しやすくする方法を研究しています。修士課程では、微細構造と界面がセンサーの性能をどう変えるかを研究し、その後、電池電極のプロセス現場では、スラリーやコーティングといったプロセス条件が品質にどう影響するかを研究してきました。

計算材料科学と機械学習をベースに、原子レベルの特性と実際のプロセス・性能とのあいだの隔たりを縮める方向へ、研究を広げています。

[履歴書(CV)全文 PDF ↗](/cv/Seunghoon_Choi_CV.pdf) · [Google Scholar ↗](https://scholar.google.com/citations?user=TRtHbDwAAAAJ) · [ORCID ↗](https://orcid.org/0009-0007-8324-2943)
...
### タコを模したソフトグリッパー：Biomimetics Review
...
[論文を見る ↗](https://doi.org/10.3390/biomimetics10120813)

## 論文

表記: † 共同第一著者 · \* 責任著者

1.  Conductive Hierarchical Hairy Fibers for Highly Sensitive, Stretchable, and Water-Resistant Multimodal Gesture-Distinguishable Sensor. Seunghoon Choi†, Kukro Yoon†, Sanggeun Lee, Heon Joon Lee, Jaehong Lee, Da Wan Kim, Min-Seok Kim, Taeyoon Lee\*, Changhyun Pang\*. _Advanced Functional Materials_ 29(50), 2019, 1905808. · 共同第一著者
...
- 繊維型センサーおよびその製造方法：KR 10-2026011 · 2019.09.20 登録
- 微細構造表面を持つ機能性手術用縫合糸およびその製造方法：KR 10-2019-0061944 · 出願 (2019)

## 受賞および発表

- 政府奨学金：学・修士連携課程 · _成均館大学校、2017_。成績優秀による全額奨学、ESPCI Paris 8週間の研究研修を含む。
- Best Poster Award：Octopus-Inspired Adhesive Patch for Bio-Signal Monitoring · _MRS Fall Meeting, Boston, 2018_
- ハイブリッドナノ複合体ベースの繊維型マルチモーダルセンサー · _韓国高分子学会 秋季学術大会、釜山、2017_

## 保有技術

- 分析・構造評価：SEM (EDS) · AFM · 光学顕微鏡 · XRD · FT-IR · UV-Vis · Contact angle measurement
- プロセス・微細構造作製：微細構造インプリンティング · 高分子表面パターニング · 伸縮性複合体の作製 · 表面コーティング
- スラリー・コロイド：スラリーレオロジー · コロイド分散の安定性 · 粒子懸濁 · 産業用ミキシング
- モデリング・データ分析：COMSOL Multiphysics (FEM) · MATLAB · Minitab (SPC) · OriginPro · Excel VBA
- プログラミング・システム：Python (PyTorch) · C++ · FAT(Factory Acceptance Test、工場受入試験) / SAT(Site Acceptance Test、現場受入試験)
