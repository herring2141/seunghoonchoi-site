...
El detalle está aquí: antes de salir del país, si todavía no tienes una cuenta bancaria americana, no puedes usar la transferencia (ACH). Solo te queda la tarjeta. Y si dejas configurada la domiciliación con tarjeta para todo un año, **te salta una comisión cada mes.** Si el alquiler es alto, solo en comisiones se te van varios cientos de dólares al año.
...
Automatizar no siempre es lo más acertado. Antes de configurar nada, conviene mirar primero "cuánto dinero se me va a escapar con esto cada mes". Sobre todo cuando, como justo después de llegar, tu único medio de pago es un apaño temporal: posponer un poco la domiciliación te ahorra dinero. Lo mejor es decidir mirando a la vez la comodidad y el coste.
