...
Un año después, la diferencia entre ambos era evidente.

¿Cambió de repente su destreza? No. Una de ellas perdía cada vez contra alguien medio nivel por encima. Al perder, sus puntos débiles quedaban a la vista, y tenía al lado a alguien que repasaba con ella esas partidas. La otra ganaba y perdía siempre en partidas parejas, y se quedaba en el mismo sitio.

Cuando los resultados se separan, por instinto lo leemos como una diferencia de talento. Esa persona es más lista, tiene la mano más rápida, da más de sí. Pero si miramos con calma, la distancia entre quien acaba bien y quien acaba mal es mucho mayor que la diferencia de capacidad con la que nacieron. La capacidad se diferencia en 1,2 veces, pero el resultado se diferencia en diez o veinte veces.

¿De dónde sale esa distancia? De que el resultado no lo crea el talento por sí solo.

## El mismo pan: la tienda del callejón quiebra

Pensemos en una panadería. Hay dos panaderos que hornean con la misma destreza. Uno abre su tienda en un callejón por donde no pasa nadie; el otro, en una calle por donde la gente pasa de forma natural.

Aunque la destreza sea la misma, uno no tiene clientes que corran la voz. El otro recibe clientes nuevos cada día que prueban el pan y vuelven. No es porque el pan sea el doble de bueno. Es porque el mismo pan llega a más gente.

El resultado es el talento multiplicado por varios factores. El campo en el que estoy, los recursos a mi alcance, la gente que tengo cerca, el tiempo acumulado, la reputación. Esto no se suma: se multiplica. Eso es lo importante.
