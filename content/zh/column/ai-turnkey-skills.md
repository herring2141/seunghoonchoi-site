...
AI 能很快给出答案，但它不会自动保证答案要去的方向。要先弄清楚：到底要解决什么问题，给谁提供什么价值，这次工作的成功标准是什么。目标不清晰，再好的提示词也会产出散乱的结果；再强的执行力，也可能冲向错误的地方。

第二，工作结构化，是把 AI 的速度变成真实生产力的能力。

把复杂的事一股脑扔给 AI，答案很容易变得散乱。你要会拆问题、排顺序、准备资料、整理判断标准。结构化不是简单整理，而是为一件事设计出能走到终点的路线。
