---
title: "AI 风险会被速度放大：没有验证的自动化如何把危机养大"
...
法律风险一开始不会像红灯一样亮起来。它通常就在很自然的句子里：把产品效果说得稍微过头的句子、依据很弱的比较、版权不清的图片、混入客户数据的案例、对竞争对手下定论式贬低的表达。
...
谨慎的人本来就会慢一点。上传危险文件前会再问一次，点公开按钮前会停一下。速度可能让人着急，但至少错误大批量跑到外面的概率低。
...
用了 AI，以后会有更多人做出更多结果。文章、代码、应用、合同草稿、广告文案、培训材料、客户回复都会变快。这件事本身是好事。问题出在速度跑到责任前面的时候。
